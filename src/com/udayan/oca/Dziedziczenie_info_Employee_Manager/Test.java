...
//        AbstractList<String> aList = (AbstractList)list2;
        ...
        C2_Employee obj1 = new C1_Manager();  //niepełny obiekt Manager  (pokaże tylko metody @Override)
     //   I obj2 = new C2_Employee();  //'C2_Employee' is abstract; cannot be instantiated
        I obj2 = new C1_Manager();  //niepełny obiekt Managera (pokaże tylko metody zaimplementowane w Manager lub Employee z interfejsu I)
        ...
        C2_Employee s = (C2_Employee)obj2;   //  s to będzie niepełny obiekt Managera
        ...
        I t = obj1;  // t -obiekt interfejsu I (widoczne tylko metody zaimplentowane z interfejsu) - obj1 - niepełny Manager
        t.displayI();


        C1_Manager manager = new C1_Manager();  //pełny Manager: odpala wszystko z Employee jeżeli nie ma Override u siebie, a jeżeli jest Overriden to je odpala
        ...
        C2_Employee emplManag = new C1_Manager(); // niepełny Manager, nie odpali metody w klasie Manager jeżeli metoda nie jest @override
